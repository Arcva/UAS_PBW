   ...
   <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    ...
    <div id="carouselExample" class="carousel slide justify-content-center">
        <div class="carousel-inner">
            ...
            $hasil = $conn->query($sql);
            $active = true; // Menandai slide pertama sebagai aktif
            
            while ($row = $hasil->fetch_assoc()) {
            ?>
                <div class="carousel-item <?= $active ? 'active' : '' ?>">
                    <img src="img/<?= $row["gambar"] ?>" class="d-block w-100" style="height: 850px; object-fit: contain;" alt="...">
                </div>
            <?php
                $active = false; // Setelah slide pertama, nonaktifkan status aktif
            }
            ?>
        </div>
    ...
    <div class="d-md-flex flex-md-row align-items-center p-5 g-5 ms-auto justify-content-center">
      ...
      <div class="col">
          <div class="card-header">
            <h2>Narendra Wijaya Nuryashofa</h2>
          </div>
          <div class="text-center"> Mahasiswa Teknik Informatika</div>
          <br>
          <div class="card-body bg-light text-dark">
            <div class="card-text"><b>NIM: </b>A11.2023.15303</div>
            <br>
            <div class="card-text"><b>Program Studi: </b>Teknik Informatika-S1</div>
            <br>
            <div class="card-text"><b>Email: </b>111202315303@mhs.dinus.ac.id</div>
            <br>
            <div class="card-text"><b>Telepon: </b>+62-8960-8979-885</div>
            <br>
            <div class="card-text"><b>Alamat: </b>Sarirejo, RT.03/RW.06</div>
          </div>
        </div>
    </div>
  </div>
